  ...
  return (
    <>
      <div
        ...
        className='flex relative overflow-hidden justify-around items-center font-mono px-10 sm-mx:px-4 xs-mx:px-2 xs-mx:py-0 h-fit lg-mx:justify-between bs-mx:flex-wrap bs-mx:flex-col-reverse bs-mx:!overflow-visible bs-mx:gap-6 md-mx:px-6'
        id='About'
      >
        {/* <Particles
        ...
        <div className='bs:ml-10 bs:w-3/5 flex flex-col lg-mx:gap-3  bs-mx:items-center'>
          <div className='text-primaryColor pointer-events-none text-3xl lg-mx:text-2xl xs-mx:text-xl xsm-mx:text-lg'>
            Hi, I am
          </div>
          ...
          <div className='xs-mx:w-[90%] flex gap-3 xs-mx:justify-between pointer-events-auto'>
            <Button
              onClick={open}
